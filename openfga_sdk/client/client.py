...
class OpenFgaClient(OpenFgaClientBase):
    ...
    async def list_stores(
        ...
        options = options or ListStoresRequestOptions()
    ...
    ) -> ReadAuthorizationModelsResponse | ApiClientResponseProtocol:
    ...
    async def read_latest_authorization_model(
        ...
        options: ReadAuthorizationModelsRequestOptions = (
            ReadAuthorizationModelsRequestOptions() | options
            or ReadLatestAuthorizationModelRequestOptions()
        )
        options.page_size = 1
