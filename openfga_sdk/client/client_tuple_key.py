...
class ClientTupleKey(TupleKey):
    ...
    def object(self, _object):
        ...
        :param _object: The object of this TupleKey.  # noqa: E501
        :type _object: str
        """
        if (self.local_vars_configuration.client_side_validation and
                _object is not None and len(_object) > 256):
    ...
    @property
    def user(self):
        """Gets the user of this TupleKey.  # noqa: E501


        :return: The user of this TupleKey.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientTupleKey):
            return False
