...
class RelationMetadata:
    ...
    """
    openapi_types = {"directly_related_user_types": "list[RelationReference]"}

    attribute_map = {"directly_related_user_types": "directly_related_user_types"}

    def __init__(self, directly_related_user_types=None, local_vars_configuration=None):
