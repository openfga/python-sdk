...
class ReadAuthorizationModelResponse:
    ...
    """
    openapi_types: dict[str, str] = {"authorization_model": "AuthorizationModel"}

    attribute_map: dict[str, str] = {"authorization_model": "authorization_model"}
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReadAuthorizationModelResponse):
            return False
