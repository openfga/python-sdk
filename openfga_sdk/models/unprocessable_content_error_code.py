...
class UnprocessableContentErrorCode:
    ...
    allowable_values = [NO_THROTTLED_ERROR_CODE, THROTTLED_TIMEOUT_ERROR]
    ...
    def __init__(self, local_vars_configuration=None):
        """UnprocessableContentErrorCode - a model defined in OpenAPI"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnprocessableContentErrorCode):
            return False
