...
class WriteAssertionsRequest:
    ...
    """
    openapi_types: dict[str, str] = {"assertions": "list[Assertion]"}

    attribute_map: dict[str, str] = {"assertions": "assertions"}
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WriteAssertionsRequest):
            return False
