...
class WriteAuthorizationModelResponse:
    ...
    """
    openapi_types: dict[str, str] = {"authorization_model_id": "str"}

    attribute_map: dict[str, str] = {"authorization_model_id": "authorization_model_id"}
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WriteAuthorizationModelResponse):
            return False
