...
from openfga_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from openfga_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __validate_inputs(self, kwargs):
        # First, verify the api_client's configuraiton is valid
    ...
    def call_with_http_info(self, **kwargs):
        ...
        for key, value in kwargs.items():
            ...
            if (key not in self.params_map['nullable'] and value is None and
                    kwargs['_check_input_type'] is False):
                raise ApiValueError(
