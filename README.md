...
- [Python SDK for OpenFGA](#python-sdk-for-openfga)
  ...
  - [Getting Started](#getting-started)
    ...
    - [Calling the API](#calling-the-api)
      ...
      - [Relationship Tuples](#relationship-tuples)
        ...
        - [Write (Create and Delete) Relationship Tuples](#write-create-and-delete-relationship-tuples)
          - [Transaction mode (default)](#transaction-mode-default)
    ...
    - [Per-Request Custom HTTP Headers](#per-request-custom-http-headers)
    - [Retries](#retries)
...
options = {
    # You can rely on the model id set in the configuration or override it for this specific request
    "authorization_model_id": "01GXSA8YR785C4FYS3C0RTG7B1",
    # Optional: Add custom headers for tracing, correlation, etc.
    "headers": {
        "x-correlation-id": "write-req-001"
    }
}
...
### Per-Request Custom HTTP Headers

You can send custom HTTP headers with any API request by providing a `headers` dictionary in the options parameter. This is useful for sending contextual information such as correlation IDs, tracing headers, or other metadata that your application or infrastructure requires.
...
# Example: Adding custom headers to a check request
options = {
    "authorization_model_id": "01GXSA8YR785C4FYS3C0RTG7B1",
    "headers": {
...
The `headers` option accepts a dictionary where keys are header names and values are header values. All values should be strings. These headers will be sent alongside the request to the OpenFGA server.

**Common use cases for custom headers:**
- **Correlation IDs**: Track requests across distributed systems
- **Tracing headers**: Integrate with observability tools  
- **Client metadata**: Send information about the calling service or user
- **API gateway routing**: Provide routing hints to intermediate infrastructure
