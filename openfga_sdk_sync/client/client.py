...
from openfga_sdk_sync.client.models.check_request import ClientCheckRequest, construct_check_request
from openfga_sdk_sync.client.models.batch_check_response import BatchCheckResponse
...
from openfga_sdk_sync.client.models.write_response import ClientWriteResponse
...
from openfga_sdk_sync.client.models.write_single_response import construct_write_single_response
...
from openfga_sdk_sync.validation import is_well_formed_ulid_string
...
class OpenFgaClient():
    ...
    def list_stores(self, options: dict[str, int | str] = None):
        """
    ...
    def delete_store(self, options: dict[str, int | str] = None):
        """
    ...
    def read_authorization_models(self, options: dict[str, int | str] = None):
        """
    ...
    def read_authorization_model(self, options: dict[str, int | str] = None):
        """
