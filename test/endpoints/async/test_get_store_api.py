...
def rest_client_response(
    ...
    api_response = mock_api_response_get_store
...
def expected_response(
    api_client_response,
    mock_api_response_get_store_deserialized,
) -> ApiResponseProtocol:
    response: ApiResponseProtocol = ApiResponse() | api_client_response
    response.deserialized = mock_api_response_get_store_deserialized
    return response
...
@pytest.mark.asyncio
class TestOpenFgaApiGetStoreEndpoint:
    """
    @covers openfga_sdk.api.open_fga_api.OpenFgaApi.get_store.
    """

    async def test_get_store_issues_request(
        self,
        ...
        """
        Test that the get_store method issues a request to ApiClient.
        """
    ...
    async def test_get_store_returns_expected_response(
        ...
        """
        Test that the get_store method returns an ApiClientResponse instance containing the expected response.
        """
        options = GetStoreRequestOptions(
            store_id=mock_api_response_get_store["id"],
        )
        ...
        with patch.object(api.api_client, **api_client_request_conditions):
            response = await api.get_store(options)
