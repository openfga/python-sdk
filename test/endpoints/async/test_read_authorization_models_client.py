...
def api_request_conditions(
    ...
    return {
        "attribute": "read_authorization_models",
...
class TestOpenFgaClientReadAuthorizationModelsEndpoint:
    """
    @covers openfga_sdk.client.OpenFgaClient.read_authorization_models
    """
    ...
    async def test_read_authorization_models_issues_request(
        ...
        """
        Test that the read_authorization_models method issues a request to OpenFgaApi.
        """
    ...
    async def test_read_authorization_models_returns_expected_response(
        ...
        """
        Test that the read_authorization_models method returns the expected response.
        """
    ...
    async def test_read_authorization_models_returns_full_response(
        self,
        client: OpenFgaClientProtocol,
        api_request_response: ApiResponse,
        api_request_conditions,
        ...
        """
        Test that the read_authorization_models method returns an ApiResponse instance containing the expected response.
        """
