...
class TestOpenFgaClientReadAuthorizationModelsEndpoint:
    """
    @covers openfga_sdk.client.OpenFgaClient.read_changes
    """
    ...
    async def test_read_changes_issues_request(
        ...
        """
        Test that the read_changes method issues a request to OpenFgaApi.
        """
        with patch.object(client.api, **api_request_conditions) as api_request:
            await client.read_changes(ClientReadChangesRequest())
    ...
    async def test_read_changes_returns_expected_response(
        ...
        """
        Test that the read_changes method returns the expected response.
        """
        with patch.object(client.api, **api_request_conditions):
            response = await client.read_changes(ClientReadChangesRequest())

            assert response is None

    async def test_read_changes_returns_full_response(
        self,
        client: OpenFgaClientProtocol,
        api_request_response: ApiResponse,
        api_request_conditions,
        ...
        """
        Test that the read_changes method returns an ApiResponse instance containing the expected response.
        """
