        ...
        response_body = """
{
  ...
  "message": "Generic validation error"
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_server_batch_check_single_request(self, mock_request):
        """Test case for check with single request
        ...
        configuration.store_id = store_id
        with OpenFgaClient(configuration) as api_client:
            api_response = api_client.server_batch_check(
                body=body,
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_server_batch_check_multiple_request(self, mock_request):
        """Test case for check with multiple request
