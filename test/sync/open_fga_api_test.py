        ...
        response_body = """
{
  ...
  "continuation_token": "token123"
        ...
        with ApiClient(configuration) as api_client:
            api_instance = open_fga_api.OpenFgaApi(api_client)
            # Get stores filtered by name
            api_response = api_instance.list_stores(name="test-store")
            self.assertIsInstance(api_response, ListStoresResponse)
        ...
        response_body = """
{
  ...
  "message": "Endpoint not enabled"
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_429_error_no_retry(self, mock_request):
        """
        ...
        response_body = """
{
  ...
  "message": "Rate Limit exceeded"
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_429_error_first_error(self, mock_request):
        """
        Test to ensure 429 errors are handled properly.
        ...
        error_response_body = """
{
  ...
  "message": "Rate Limit exceeded"
    ...
    @patch("time.sleep")
    @patch.object(rest.RESTClientObject, "request")
    def test_429_error_retry_exponential_backoff(self, mock_request, mock_sleep):
        """
        Test to ensure 429 errors are handled properly.
        ...
        response_body = """
{
  ...
  "message": "Not Implemented"
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_check_custom_header_override_default_header(self, mock_request):
    ...
    @patch.object(rest.RESTClientObject, "request")
    def test_check_per_request_header_and_default_header_coexist(self, mock_request):
