...
from openfga_sdk_sync.api import open_fga_api
from openfga_sdk_sync.credentials import Credentials, CredentialConfiguration
from openfga_sdk_sync.exceptions import FgaValidationException, ApiValueError, NotFoundException, RateLimitExceededError, ServiceException, ValidationException, FGA_REQUEST_ID
...
class TestOpenFgaApi(IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        self.configuration = openfga_sdk_sync.Configuration(
            api_scheme='http',
    ...
    async def test_check(self, mock_request):
        ...
        with openfga_sdk_sync.ApiClient(configuration) as api_client:
        ...
        response_body = '''
{
  ...
  "continuation_token": "eyJwayI6IkxBVEVTVF9OU0NPTkZJR19hdXRoMHN0b3JlIiwic2siOiIxem1qbXF3MWZLZExTcUoyN01MdTdqTjh0cWgifQ=="
    ...
    def test_default_scheme(self):
        ...
        """
        configuration = openfga_sdk_sync.Configuration(
            api_host='localhost'
        )
        ...
        response_body = '''
{
  ...
  "message": "Rate Limit exceeded"
        ...
        retry = openfga_sdk_sync.configuration.RetryParams(0, 10)
        configuration = self.configuration
        configuration.store_id = store_id
        ...
        error_response_body = '''
{
  ...
  "message": "Rate Limit exceeded"
        ...
        retry = openfga_sdk_sync.configuration.RetryParams(1, 10)
        configuration = self.configuration
        configuration.store_id = store_id
        configuration.retry_params = retry
        with openfga_sdk_sync.ApiClient(configuration) as api_client:
